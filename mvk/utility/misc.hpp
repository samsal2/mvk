...
template <typename Container> struct data_and_size
{
...
[[nodiscard]] static constexpr detail::data_and_size<Container> bind_data_and_size(Container & src) noexcept
{
...
template <typename Container>
requires with_data_and_size<Container>
[[nodiscard]] static constexpr detail::data_and_size_as_bytes bind_data_and_size_as_bytes(Container const & src) noexcept
{
