...
public:
  ...
  constexpr explicit compressed_pair_element(U && value) noexcept
...
class compressed_pair : private compressed_pair_element<0, First>,
                        private compressed_pair_element<1, Second>
{
...
public:
  ...
  constexpr compressed_pair([[maybe_unused]] first_tag tag,
                            U1 && first) noexcept
      : first_element_type(std::forward<U1>(first))
  {
  }
  ...
  constexpr compressed_pair([[maybe_unused]] second_tag tag,
                            U2 && second) noexcept
      : second_element_type(std::forward<U2>(second))
  {
  }
