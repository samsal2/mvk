...
namespace mvk::detail
{
  ...
  [[nodiscard]] types::unique_command_pool create_command_pool( types::device            device,
                                                                types::queue_index       queue_index,
                                                                VkCommandPoolCreateFlags flags = 0 ) noexcept;

  [[nodiscard]] std::vector<types::unique_command_buffer> create_command_buffers( types::device        device,
                                                                                  types::command_pool  pool,
                                                                                  u32                  count,
                                                                                  VkCommandBufferLevel level ) noexcept;

  [[nodiscard]] types::unique_device_memory create_device_memory( types::device          device,
  ...
  [[nodiscard]] types::unique_shader_module create_shader_module( types::device              device,
