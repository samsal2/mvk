...
namespace mvk::detail
{
  ...
  [[nodiscard]] std::optional<types::physical_device> choose_physical_device(
    types::instance instance, types::surface surface, utility::slice<char const * const> device_extensions ) noexcept;
  ...
  [[nodiscard]] bool
    check_surface_support( types::physical_device physical_device, types::surface surface, u32 index ) noexcept;
