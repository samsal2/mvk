...
static constexpr auto g_validation_layers =
  std::array{"VK_LAYER_KHRONOS_validation"};

static constexpr auto g_validation_instance_extensions =
...
static constexpr auto g_debug_create_info = []
{
  ...
  tmp.messageType = VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT |
