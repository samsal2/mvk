...
private:
        ...
        static constexpr auto default_deleter = std::is_default_constructible_v<deleter_type>;
...
public:
        ...
        template <typename U>
        constexpr explicit wrapper(container_type container, U && deleter) noexcept : container_(std::move(container), std::forward<U>(deleter))
        {
        }
