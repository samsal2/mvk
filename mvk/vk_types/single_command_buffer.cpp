...
single_command_buffer &
single_command_buffer::pipeline_barrier(pipeline_barrier_information information, utility::slice<VkMemoryBarrier> memory_barriers,
                                        ...
                                        utility::slice<VkImageMemoryBarrier>  image_memory_barriers) noexcept
{
    ...
    vkCmdPipelineBarrier(command_buffer_, source_stage, destination_stage, dependency_flags, static_cast<uint32_t>(memory_barriers_size), memory_barriers_data,
                         static_cast<uint32_t>(buffer_memory_barriers_size), buffer_memory_barriers_data, static_cast<uint32_t>(image_memory_barriers_size),
...
single_command_buffer &
single_command_buffer::blit_image(blit_image_information source, blit_image_information destination, utility::slice<VkImageBlit> regions,
