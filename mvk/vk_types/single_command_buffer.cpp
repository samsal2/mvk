...
single_command_buffer::copy_buffer_to_image(
  ...
  VkImage const                           destination_image,
  VkImageLayout const                     destination_image_layout,
...
single_command_buffer::copy_buffer(
  VkBuffer const                     source_buffer,
  VkBuffer const                     destination_buffer,
  utility::slice<VkBufferCopy> const copy_regions) noexcept
{
  auto const [copy_regions_data, copy_regions_size] =
    utility::bind_data_and_size(copy_regions);
...
single_command_buffer::pipeline_barrier(
  VkPipelineStageFlags const            source_stage,
  VkPipelineStageFlags const            destination_stage,
  VkDependencyFlags const               dependency_flags,
  ...
  utility::slice<VkImageMemoryBarrier>  image_memory_barriers) noexcept
{
  ...
  vkCmdPipelineBarrier(
    ...
    destination_stage,
    dependency_flags,
    static_cast<uint32_t>(memory_barriers_size),
    memory_barriers_data,
...
single_command_buffer &
single_command_buffer::bind_pipeline(
...
single_command_buffer &
single_command_buffer::bind_index_buffer(
...
single_command_buffer::bind_descriptor_sets(
  ...
  uint32_t const            descriptor_set_first,
...
single_command_buffer &
single_command_buffer::draw_indexed(
...
single_command_buffer &
single_command_buffer::blit_image(
  VkImage const                     source_image,
  VkImageLayout const               source_image_layout,
  VkImage const                     destination_image,
  VkImageLayout const               destination_image_layout,
  utility::slice<VkImageBlit> const regions,
  VkFilter const                    filter) noexcept
{
  ...
  vkCmdBlitImage(
    ...
    destination_image,
    destination_image_layout,
    static_cast<uint32_t>(regions_size),
    regions_data,
    filter);
