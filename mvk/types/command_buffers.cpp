...
command_buffers::command_buffers(VkDevice const device, VkCommandBufferAllocateInfo const & allocate_info) : wrapper({allocate_info.commandBufferCount, nullptr}, device, allocate_info.commandPool)
{
