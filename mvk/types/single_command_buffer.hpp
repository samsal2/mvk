...
public:
    ...
    single_command_buffer &
    pipeline_barrier(pipeline_barrier_information pipeline_barrier_information, utility::slice<VkMemoryBarrier> memory_barriers, utility::slice<VkBufferMemoryBarrier> buffer_memory_barriers,
                     utility::slice<VkImageMemoryBarrier> image_memory_barriers) noexcept;

    single_command_buffer &
    bind_descriptor_sets(VkPipelineBindPoint bind_point, VkPipelineLayout pipeline_layout, uint32_t descriptor_set_first, uint32_t descriptor_set_count, VkDescriptorSet descriptor_set) noexcept;
