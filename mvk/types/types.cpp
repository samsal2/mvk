                     ...
                     VkBufferCreateInfo const & info) noexcept
{
  ...
  MVK_VERIFY(result == types::VK_SUCCESS);
    ...
    device const device, VkPipelineLayoutCreateInfo const & info) noexcept
{
  ...
  return types::unique_pipeline_layout(types::get(handle),
                                       types::get(device));
}
    ...
    device const device, VkDescriptorPoolCreateInfo const & info) noexcept
{
  ...
  return types::unique_descriptor_pool(types::get(handle),
                                       types::get(device));
}
                      ...
                      VkSamplerCreateInfo const & info) noexcept
{
  ...
  [[maybe_unused]] auto result = vkCreateSampler(
      types::get(device), &info, nullptr, &types::get(handle));
