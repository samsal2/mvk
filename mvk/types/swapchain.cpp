...
swapchain::swapchain(VkDevice const device, VkSwapchainCreateInfoKHR const & create_info) : wrapper(nullptr, device), extent_(create_info.imageExtent), format_(create_info.imageFormat)
{
