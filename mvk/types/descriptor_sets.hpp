...
class descriptor_sets : public detail::wrapper<detail::deleter<vkFreeDescriptorSets>, detail::handle<std::vector<VkDescriptorSet>>, detail::parent<VkDevice>, detail::pool<VkDescriptorPool>>
{
public:
